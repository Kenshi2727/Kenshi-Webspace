...
export default function MyArticlesPage() {
    ...
    return (
        <motion.div
            ...
            className="min-h-screen bg-gradient-to-br from-purple-950 to-purple-800 dark:from-indigo-950 dark:via-purple-950 dark:to-slate-950 py-10 px-4 sm:px-8 lg:px-16"
        >
