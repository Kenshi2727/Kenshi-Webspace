...
export default function SsoCallback() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-slate-900 dark:from-indigo-950 dark:via-purple-950 flex items-center justify-center p-6">
            <motion.div
